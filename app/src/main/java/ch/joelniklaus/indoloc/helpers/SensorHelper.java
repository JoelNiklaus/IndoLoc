        ...
        */
        ...
        if (event.sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD) {
           ...
           /* magnetic[0] = event.values[0];
            ...
            magneticFingerprint[0] = (float) (Math.round(A_W[0]*100)/100.0);
            magneticFingerprint[1] = (float) (Math.round(A_W[1]*100)/100.0);
            magneticFingerprint[2] = (float) (Math.round(A_W[2]*100)/100.0);
